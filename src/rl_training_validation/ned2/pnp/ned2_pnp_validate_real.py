#!/usr/bin/env python3
"""
Validate a trained SB3 policy on the Ned2 *real* Pick-and-Place task.
...
See ned2_pnp_train_real.py for the safety gating, cube tracking, and
``--multi-goal`` prerequisites.
"""
