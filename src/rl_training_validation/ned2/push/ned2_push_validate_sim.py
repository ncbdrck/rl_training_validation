#!/usr/bin/env python3
"""
Stub: Ned2 Push (sim) — validate.

This task is registered as ``UniROS-Ned2PushSim-v0`` but routes to
...
if __name__ == "__main__":
    sys.exit(run_blocked_stub(
        "UniROS-Ned2PushSim-v0",
        real=False,
        reason="Ned2 sim cube/table interface (Niryo workspace_1 + cube models) not yet wired.",
    ))
