...
def main() -> int:
    ...
    if args.goal:
        cfg = CFG_GOAL
        save_path = "/models/sim/td3_goal/rx200/pnp/" if args.algo == "td3" else "/models/sim/sac_goal/rx200/pnp/"
        log_path  = "/logs/sim/td3_goal/rx200/pnp/"   if args.algo == "td3" else "/logs/sim/sac_goal/rx200/pnp/"
        ModelCls = TD3_GOAL if args.algo == "td3" else SAC_GOAL
    else:
        cfg = CFG_STD
        save_path = "/models/sim/td3/rx200/pnp/" if args.algo == "td3" else "/models/sim/sac/rx200/pnp/"
        log_path  = "/logs/sim/td3/rx200/pnp/"   if args.algo == "td3" else "/logs/sim/sac/rx200/pnp/"
