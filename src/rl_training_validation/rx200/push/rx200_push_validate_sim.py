...
def main() -> int:
    ...
    if args.goal:
        cfg = CFG_GOAL
        base = "/models/sim/td3_goal/rx200/push/" if args.algo == "td3" else "/models/sim/sac_goal/rx200/push/"
        ModelCls = TD3_GOAL if args.algo == "td3" else SAC_GOAL
    else:
        cfg = CFG_STD
        base = "/models/sim/td3/rx200/push/" if args.algo == "td3" else "/models/sim/sac/rx200/push/"
