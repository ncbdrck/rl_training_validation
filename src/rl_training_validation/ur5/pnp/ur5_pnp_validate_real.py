#!/usr/bin/env python3
"""
Stub: UR5 Pick-and-Place (real) — validate.

This task is registered as ``UniROS-UR5PnPReal-v0`` but routes to
...
if __name__ == "__main__":
    sys.exit(run_blocked_stub(
        "UniROS-UR5PnPReal-v0",
        real=True,
        reason="UR5 has no default gripper; real env class also not implemented.",
    ))
