#!/usr/bin/env python3
"""
Stub: UR5 Pick-and-Place (sim) — validate.

This task is registered as ``UniROS-UR5PnPSim-v0`` but routes to
...
if __name__ == "__main__":
    sys.exit(run_blocked_stub(
        "UniROS-UR5PnPSim-v0",
        real=False,
        reason="UR5 has no default gripper in ur_description; PnP blocked until a Robotiq (or similar) gripper is added.",
    ))
