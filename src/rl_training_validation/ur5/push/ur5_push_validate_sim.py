#!/usr/bin/env python3
"""
Stub: UR5 Push (sim) — validate.

This task is registered as ``UniROS-UR5PushSim-v0`` but routes to
...
if __name__ == "__main__":
    sys.exit(run_blocked_stub(
        "UniROS-UR5PushSim-v0",
        real=False,
        reason="UR5 sim table/cube setup not verified.",
    ))
