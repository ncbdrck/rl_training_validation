#!/usr/bin/env python3
"""
Train an SB3 policy on the UR5e *real* Pick-and-Place task.
...
See ur5e_push_train_real.py for the cube-tracking + safety gating
...
def main() -> int:
    ...
    if args.goal:
        cfg = CFG_GOAL
        save_path = "/models/real/td3_goal/ur5e/pnp/"
        log_path = "/logs/real/td3_goal/ur5e/pnp/"
        ModelCls = TD3_GOAL
    else:
        cfg = CFG_STD
        save_path = "/models/real/td3/ur5e/pnp/"
        log_path = "/logs/real/td3/ur5e/pnp/"
        ModelCls = TD3
