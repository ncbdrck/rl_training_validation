#!/usr/bin/env python3
"""
Train an SB3 policy on the UR5e *real* Push task.
...
def main() -> int:
    ...
    if args.goal:
        cfg = CFG_GOAL
        save_path = "/models/real/td3_goal/ur5e/push/"
        log_path = "/logs/real/td3_goal/ur5e/push/"
        ModelCls = TD3_GOAL
    else:
        cfg = CFG_STD
        save_path = "/models/real/td3/ur5e/push/"
        log_path = "/logs/real/td3/ur5e/push/"
        ModelCls = TD3
