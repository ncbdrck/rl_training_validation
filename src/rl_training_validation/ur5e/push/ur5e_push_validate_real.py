#!/usr/bin/env python3
"""
Stub: UR5e Push (real) — validate.

This task is registered as ``UniROS-UR5ePushReal-v0`` but routes to
...
if __name__ == "__main__":
    sys.exit(run_blocked_stub(
        "UniROS-UR5ePushReal-v0",
        real=True,
        reason="UR5e real env class + perception not yet implemented.",
    ))
