#!/usr/bin/env python3
"""
Validate a trained policy against the UR5e sim Push task.

Mirrors ``ur5e_push_train_sim.py`` for env construction; loads a
...
ENV_STD  = "UR5ePushSim-v0"
ENV_GOAL = "UR5ePushGoalSim-v0"
...
def main() -> int:
    ...
    if args.goal:
        cfg = CFG_GOAL
        base = "/models/sim/td3_goal/ur5e/push/"
        ModelCls = TD3_GOAL
    else:
        cfg = CFG_STD
        base = "/models/sim/td3/ur5e/push/"
        ModelCls = TD3
