...
def main() -> int:
    ...
    if args.goal:
        if args.algo == "td3":
            cfg = "ur5e_reacher_td3_goal.yaml"
            base = "/models/real/td3_goal/ur5e/reach/"
            ModelCls = TD3_GOAL
        else:
            cfg = "ur5e_reacher_sac_goal.yaml"
            base = "/models/real/sac_goal/ur5e/reach/"
            ModelCls = SAC_GOAL
    else:
        if args.algo == "td3":
            cfg = "ur5e_reacher_td3.yaml"
            base = "/models/real/td3/ur5e/reach/"
            ModelCls = TD3
        else:
            cfg = "ur5e_reacher_sac.yaml"
            base = "/models/real/sac/ur5e/reach/"
            ModelCls = SAC
    ...
    if not os.path.exists(abs_model_path + ".zip"):
        raise SystemExit(
            ...
            "or run ur5e_reach_train_real.py first."
        )
