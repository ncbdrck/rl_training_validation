#!/usr/bin/env python3
"""
Validate a trained TD3 policy against the UR5e sim Slide task.

Mirrors ``ur5e_slide_train_sim.py`` for env construction; loads a
...
def main() -> int:
    ...
    if args.goal:
        cfg = CFG_GOAL
        base = "/models/sim/td3_goal/ur5e/slide/"
        ModelCls = TD3_GOAL
    else:
        cfg = CFG_STD
        base = "/models/sim/td3/ur5e/slide/"
        ModelCls = TD3
