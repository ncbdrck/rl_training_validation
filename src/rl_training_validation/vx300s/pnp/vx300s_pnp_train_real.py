#!/usr/bin/env python3
"""
Train an SB3 policy on the VX300S *real* Pick-and-Place task.
...
See vx300s_push_train_real.py for the cube-tracking + safety gating
...
ENV_STD = "VX300SPnPReal-v0"
ENV_GOAL = "VX300SPnPGoalReal-v0"
CFG_STD = "vx300s_pnp_td3.yaml"
CFG_GOAL = "vx300s_pnp_td3_goal.yaml"
...
def main() -> int:
    ...
    if args.goal:
        cfg = CFG_GOAL
        save_path = "/models/real/td3_goal/vx300s/pnp/"
        log_path = "/logs/real/td3_goal/vx300s/pnp/"
        ModelCls = TD3_GOAL
    else:
        cfg = CFG_STD
        save_path = "/models/real/td3/vx300s/pnp/"
        log_path = "/logs/real/td3/vx300s/pnp/"
        ModelCls = TD3
