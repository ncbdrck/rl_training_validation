#!/usr/bin/env python3
"""
Train an SB3 policy on the VX300S sim Pick-and-Place task.

Standard env id:  ``VX300SPnPSim-v0``
Goal env id:      ``VX300SPnPGoalSim-v0``
...
ENV_STD  = "VX300SPnPSim-v0"
ENV_GOAL = "VX300SPnPGoalSim-v0"
...
def main() -> int:
    ...
    if args.goal:
        cfg = CFG_GOAL
        save_path = "/models/sim/td3_goal/vx300s/pnp/"
        log_path  = "/logs/sim/td3_goal/vx300s/pnp/"
        ModelCls = TD3_GOAL
    else:
        cfg = CFG_STD
        save_path = "/models/sim/td3/vx300s/pnp/"
        log_path  = "/logs/sim/td3/vx300s/pnp/"
        ModelCls = TD3
