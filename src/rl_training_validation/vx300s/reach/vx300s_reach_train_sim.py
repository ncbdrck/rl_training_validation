...
ENV_STD  = "VX300SReacherSim-v0"
ENV_GOAL = "VX300SReacherGoalSim-v0"
CFG_STD_TD3 = "vx300s_reacher_td3.yaml"
CFG_STD_SAC = "vx300s_reacher_sac.yaml"
CFG_GOAL_TD3 = "vx300s_reacher_td3_goal.yaml"
CFG_GOAL_SAC = "vx300s_reacher_sac_goal.yaml"
...
def main() -> int:
    ...
    if args.goal:
        ...
        save_path = "/models/sim/td3_goal/vx300s/reach/" if args.algo == "td3" else "/models/sim/sac_goal/vx300s/reach/"
        log_path  = "/logs/sim/td3_goal/vx300s/reach/"   if args.algo == "td3" else "/logs/sim/sac_goal/vx300s/reach/"
        ModelCls = TD3_GOAL if args.algo == "td3" else SAC_GOAL
    else:
        cfg = CFG_STD_TD3 if args.algo == "td3" else CFG_STD_SAC
        save_path = "/models/sim/td3/vx300s/reach/" if args.algo == "td3" else "/models/sim/sac/vx300s/reach/"
        log_path  = "/logs/sim/td3/vx300s/reach/"   if args.algo == "td3" else "/logs/sim/sac/vx300s/reach/"
