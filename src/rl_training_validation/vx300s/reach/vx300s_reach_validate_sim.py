...
def main() -> int:
    ...
    if args.goal:
        ...
        base = "/models/sim/td3_goal/vx300s/reach/" if args.algo == "td3" else "/models/sim/sac_goal/vx300s/reach/"
        ModelCls = TD3_GOAL if args.algo == "td3" else SAC_GOAL
    else:
        cfg = CFG_STD_TD3 if args.algo == "td3" else CFG_STD_SAC
        base = "/models/sim/td3/vx300s/reach/" if args.algo == "td3" else "/models/sim/sac/vx300s/reach/"
